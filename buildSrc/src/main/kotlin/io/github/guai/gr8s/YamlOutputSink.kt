...
//		disable(MapperFeature.AUTO_DETECT_IS_GETTERS) // doesn't help with Volume#csi/Volume#iscsi
		...
		val byteArrayModule = com.fasterxml.jackson.databind.module.SimpleModule().apply {
			addSerializer(ByteArray::class.java, io.kuberig.core.generation.yaml.ByteArraySerializer())
			addDeserializer(ByteArray::class.java, io.kuberig.core.generation.yaml.ByteArrayDeserializer())
		}
